          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="footer__info pb-3">
              ...
              <div class="footer__summary my-3">
                <p>
                  Student Life Jobs is a service of the
          ...
          <div class="col-12 col-md-6 col-lg-8">
            <div class="footer__navigation pb-3">
              <div class="row">
                <div class="col">
                  <div class="footer__links">
                    ...
                    <ul class="list-unstyled row">
                      <li class="col-6">
                        <NuxtLink href="/" class="text-light d-block py-2">Find a Job</NuxtLink>
                      </li>

                      <li class="col-6">
                        <NuxtLink href="/working-on-campus/" class="text-light d-block py-2"
                          >Working on Campus
                        </NuxtLink>
                      </li>

                      <li class="col-6">
                        <NuxtLink href="/departments/" class="text-light d-block py-2"
                          >Departments</NuxtLink
                        >
                      </li>

                      <li class="col-6">
                        <NuxtLink href="/contact" class="text-light d-block py-2"
                          >Contact Us</NuxtLink
                        >
                      </li>
                    </ul>
                ...
                <div class="col-lg-4">
                  <div class="footer__buttons py-2"></div>
                </div>
              </div>
            </div>
          </div>
