                ...
                <div class="col">
                  <div class="footer__links">
                    ...
                    <ul class="list-unstyled row">
                      ...
                      <li class="col-6">
                        <NuxtLink href="/working-on-campus/" class="text-light d-block py-2">Working on Campus
                        </NuxtLink>
                      </li>

                      <li class="col-6">
                        <NuxtLink href="/departments/" class="text-light d-block py-2">Departments</NuxtLink>
                      </li>
